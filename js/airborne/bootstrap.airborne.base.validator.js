airborne.validator = {
	...
	,is_array:function(targetArr){
		if(targetArr != null && jQuery.type( targetArr ) === "array"){
			return true;
		}
		return false;
	}
	...
	,is_valid_boolean:function(target){
		return this.isValidBoolean(target);
	}
